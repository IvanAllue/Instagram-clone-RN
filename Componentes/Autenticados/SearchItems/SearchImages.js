        ...
        if (typeof this.props.item[2].publicacion != "undefined") {
            return (
                <View style={{ height: width * 0.3, flexDirection: "row", marginBottom: 3, justifyContent: "space-between" }}>
                    ...
                    <TouchableHighlight onPress={() => { this.props.navigation.navigate('PostProfile', { imagen: this.props.item[1].publicacion, user: this.props.item[1].usuario, editor: this.props.editor }) }}>
                        <Image style={{ width: width * 0.33, height: width * 0.3 }} source={{ uri: this.props.item[1].publicacion.url }} />
                    </TouchableHighlight>
                    <TouchableHighlight onPress={() => { this.props.navigation.navigate('PostProfile', { imagen: this.props.item[2].publicacion, user: this.props.item[2].usuario, editor: this.props.editor }) }}>
